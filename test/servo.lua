...
local test_func = {
    ...
    function ()
        ...
        print("#c", #c)
        print("c:lensq", c:lensq())
        print("c:dot(c:rotate(rad(90)))", c:dot(c:rotate(math.rad(90))))
        ...
        print("#h", #h)
        print("h:lensq", h:lensq())
        print("h:dot(h:rotatx(rad(90)))", h:dot(h:rotatex(math.rad(90))))
        print("h:dot(h:rotaty(rad(90)))", h:dot(h:rotatey(math.rad(90))))
        print("h:dot(h:rotatz(rad(90)))", h:dot(h:rotatez(math.rad(90))))
        ...
        print("k:det", k:det())
        m:transform(1, 2, math.rad(90), 3, 4, 5, 6, 7, 8)
        print("m:transform", m)
        ...
        print("p - r", p - r)
        print("p * r", p * r)
        print("r:rotate(1, 1, 1)", r:rotate(1, 1, 1))
        print("-p", -p)
        print("p:conjugate", p:conjugate())
        print("#quat(1, 5, 0, 0), sqrt(26)", #sevo.math.quat(1, 5, 0, 0), math.sqrt(26))
        print("r:matrix", r:matrix())
        print("r:euler", r:euler())
    end,
}
local test_step = 1
